...
func (r *serviceRepository) SeedService(ctx context.Context) error {
	services := []*service.Services{
		...
		// e. Tai - Mũi - Họng
		{ServiceId: uuid.New(), ServiceCode: "DV501", ServiceName: "Khám tai", Cost: 600, ServiceSubCategoryId: 5},
		{ServiceId: uuid.New(), ServiceCode: "DV502", ServiceName: "Khám mũi", Cost: 600, ServiceSubCategoryId: 5},
		{ServiceId: uuid.New(), ServiceCode: "DV503", ServiceName: "Khám họng", Cost: 600, ServiceSubCategoryId: 5},
		{ServiceId: uuid.New(), ServiceCode: "DV504", ServiceName: "Nội soi tai mũi họng", Cost: 600, ServiceSubCategoryId: 5},
